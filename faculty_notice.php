		...
		<div class="row">
			<div class="col-md-2 container bg-warning sticky-top mt-5 mb-5" style="padding: 10px; margin-left: 20px; height: 550px; width: 200px;">
				<div class="dropdown" style="font-size: 20px;">
				  ...
				  <a class="dropdown-item active" href="faculty_notice.php">Notice Board</a>
							...
							<div class="card-body">
							    <p class="card-text text-center">
							    	...
							    	<?php  
										...
										$select="select * from noticemaster where type='faculty' or type='general' order by date desc"; 
										...
										echo "<table border='1px' cellpadding='10px' cellspacing='0px'>";
											...
											{	
												...
												echo "<tr>
														...
														<td>".$row['date']."</td>
														<td><a href='display_faculty_notice.php?title=$title'>".$row['title']."</a></td>
													</tr>";
