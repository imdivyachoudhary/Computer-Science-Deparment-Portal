							...
							<div class="card-body">
							    <p class="card-text text-center">
							    	...
							    	<?php  
										...
										$select="select * from noticemaster order by date desc"; 
										...
										echo "<table border='1px' cellpadding='10px' cellspacing='0px'>";
											...
											{	
												...
												echo "<tr>
														...
														<td>".$row['date']."</td>
														<td><a href='display_admin_notice.php?title=$title'>".$row['title']."</a></td>
														<td>".$row['userid']."</td>
														<td><a href='edit_notice.php?sno=$sno'> Edit </a></td>
														<td><a href='remove_notice.php?sno=$sno&title=$title'> Remove </a></td>
													</tr>";
